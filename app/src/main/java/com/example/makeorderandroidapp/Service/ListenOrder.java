package com.example.makeorderandroidapp.Service;
...
import com.example.makeorderandroidapp.OrderStatus;
...
public class ListenOrder extends Service implements ChildEventListener {
    ...
    private void showNotification(String key, Request request) {
        ...
        builder.setAutoCancel(true)
                ...
                .setContentText("Order status #"+key+"  is updated to "+ Common.convertCodeToStatus(request.getStatus()))
